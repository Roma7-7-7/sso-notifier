...
[![Coverage](https://img.shields.io/badge/coverage-83.4%25-brightgreen)](https://github.com/Roma7-7-7/sso-notifier)
...
Docker images are automatically built and pushed to GHCR on every push to `main`.
